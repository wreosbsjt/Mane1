...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@F_P_l "))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس بيثون يعمل بنجاح ⚡️**')
...
💞 مرحبا بك في اوامر سورس بيثون [ @F_P_l  ]
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس بيثون 
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('Bethon2'))
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | Bethon")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('F_P_l '))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس بيثون **')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('Bethon2'))
